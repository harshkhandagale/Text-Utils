        ...
        <nav className={`navbar navbar-expand-lg navbar-${props.mode} bg-${props.mode}`}>
            <div className="container-fluid">
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    {/* <div className='mt-2 my-2 mr-2 '><strong>Customize Theme</strong></div> */}
                    {/* theme changer */}
                    {/* <div className="d-flex">
                        ...
                        <div className="bg-white rounded mx-2" onClick={()=>{props.toggleMode('white')}} style={{height: '20px', width: '20px', cursor: 'pointer'}}></div>
